				...
				<div class = "rightDiv1">
					...
					<h3>Available Products</h3>
						...
						if (isset($_GET['page'])){
							...
							$counter = 0;
							$sql = "SELECT * FROM  selecteditems WHERE selecteditems.category='$value' LIMIT $limit,12";
							...
							if($resultCheck > 0) {
								while($row = mysqli_fetch_assoc($result)) {
										...
										echo "<li> <a href = 'productDetail.php?p_id=".$row['ProductID']."'>";
	 					...
	 					<div class="pagination">
	 							<?php 
	 								$sql = "SELECT * FROM selecteditems WHERE category='$value'";
	 							...
	 							?>
	 								<a href="category.php?value=<?php echo $value; ?>&page=<?php echo $pageNo;?>" style="text-decoration:none"><?php echo $pageNo." "; ?></a>
	 							<?php
	 								}
	 							?>
