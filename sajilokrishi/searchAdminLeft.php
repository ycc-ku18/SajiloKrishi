<?php 
	...
	if (isset($_POST['searchProductProducer'])){
		$keyword = $_POST['keyword'];
	}else{
		header('location:filterProducts.php');
	}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
	<div class = "mainWrapper">
		...
		<?php 
			$sql = "SELECT * from products WHERE keyword LIKE '%$keyword%' OR ProductName like '%$keyword%'";
		...
		<div class = "div2">
			...
			<div class = "div2B">
				...
				<form action="searchAdminRightBottom" method = "POST">
					<input type="text" placeholder="Product Name" name = "keyword">
